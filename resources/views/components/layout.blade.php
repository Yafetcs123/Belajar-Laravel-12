        ...
        <div class="flex flex-1 items-center justify-end md:justify-between">
            <nav aria-label="Global" class="hidden md:block">
                <ul class="flex items-center gap-6 text-x">
                    <li>
                        <x-nav-link class="text-gray-500 transition hover:text-gray-500/75" href="/" :active="request()->is('/')"> Home
                        </x-nav-link>
                    </li>
                    <li>
                    ...
                    <li>
                        <x-nav-link class="text-gray-500 transition hover:text-gray-500/75" href="/data" :active="request()->is('data')"> data
                        </x-nav-link>
                    </li>
                </ul>
            </nav>
